...
Template.failedCourse.helpers({
  color: function(){
    let color = "#ef9a9a";
    if ((this.try1 > 9) || (this.try2 > 9)) color = "#a5d6a7"; //Passed
    else if ((this.try1 >= 8 && this.try1 <= 9) || (this.try2 >= 8 && this.try2 <= 9)) color =  "#ffcc80"; // Tolerated
...
Template.failedCourse.onRendered(function(){
  ...
  // container.attr("width",totalWidth)
